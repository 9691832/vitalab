...
def cadastro(request):
    if request.method == "GET":
        ...
        if len(senha) <6:
            messages.add_message(request, constants.ERROR, 'Senha não pode ter menos que 6 caracteres')
            return redirect('/usuarios/cadastro')
        try:
            ...
            messages.add_message(request, constants.SUCCESS, F'Olá {primeiro_nome}, seu cadastro foi realizado com sucesso')
        except:
